DELETE FROM public.nce_section_map WHERE section_pattern IN ('Windows%', '%windows%');

INSERT INTO public.nce_section_map (trade_key, category_key, section_pattern) VALUES
  ('windows', NULL, '%finish windows%'),
  ('windows', NULL, '%insulating glass%'),
  ('windows', NULL, 'Window Sills%'),
  ('windows', NULL, 'Window Wells'),
  ('doors_windows', 'windows', '%finish windows%'),
  ('doors_windows', 'windows', '%insulating glass%'),
  ('doors_windows', NULL, '%finish windows%'),
  ('doors_windows', NULL, '%insulating glass%'),
