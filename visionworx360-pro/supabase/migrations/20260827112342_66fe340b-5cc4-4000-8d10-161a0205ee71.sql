...
DECLARE
  ...
  v_material_total numeric; v_other_total numeric; v_labor_rate numeric;
  ...
  FOR v_task IN SELECT value FROM jsonb_array_elements(_tasks) LOOP
    ...
    UPDATE public.estimate_line_items li
       SET quantity = v_quantity,
           ...
           labor_hours_setup = 0, labor_hours = round(v_labor_hours * 4) / 4,
           labor_rate = v_labor_rate, material_cost = round(v_material_total / v_quantity, 2),
           equipment_cost = 0, subcontractor_cost = 0, other_cost = round(v_other_total / v_quantity, 2),
           cost_basis = 'labor_production', cost_basis_source = 'contractor',
           labor_hours_basis = 'contractor', labor_convention = 'hours_per_unit',
